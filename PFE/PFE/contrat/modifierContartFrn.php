...
$postdata = file_get_contents("php://input"); 
    if (isset($postdata)) {
		...
		`structure_technique`='$structure_technique',`piece_joite`='$piece_joite',`renouvele`='$renouvele',`date_de_preavis`='$date_de_preavis',`date_de_facturation`='$date_de_facturation'
